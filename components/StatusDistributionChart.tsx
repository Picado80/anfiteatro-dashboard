...
const renderCustomLabel = ({ cx, cy, midAngle, innerRadius, outerRadius, percent, _name, value }: any)nst renderCustomLabel = ({ cx, cy, midAngle, innerRadius, outerRadius, percent, name, value }: any) => {
